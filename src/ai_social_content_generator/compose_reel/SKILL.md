## Compose Talking Head Reel Prompt
...
The chosen hook IS the opening line of the reel. It is what the creator
says or shows in the first 3 seconds. Use it verbatim, or refine
minimally for spoken cadence.

YOUR TASK
Compose ONE complete Instagram reel that the creator can shoot today,
matching their voice and informed by what works on their account.

The reel must:
- Be 15-30 seconds total (read aloud at natural pacing).
- Open with the chosen hook in the first 3 seconds.
...
## Hook (0-3 seconds)
**Spoken:** [What the creator says in the first 3 seconds, based on the chosen hook.]
...
4. The Hook (0-3s) MUST use the chosen headline as opening line (or a
