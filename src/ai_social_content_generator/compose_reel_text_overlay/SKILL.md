## Compose Text-Overlay Reel Prompt
...
CHOSEN TOPIC FOR THIS REEL:
"{chosen_topic}"

CHOSEN HOOK (the creator selected this opening line):
"{chosen_headline}"

The chosen hook IS the opening text block of the reel. It is what
appears first on screen. Use it verbatim or refine minimally for
on-screen punch.

YOUR TASK
Compose ONE complete text-overlay reel the creator can publish today.
The output is a sequence of TEXT BLOCKS that appear on screen,
overlaid on simple b-roll background video. Match their voice and
informed by what works on their account.

The reel must:
- Be 15-30 seconds total reading time.
- Open with the chosen hook as the first text block.
...
[The opening text that appears on screen, based on chosen headline.
...
4. The Hook Text Block MUST use the chosen headline as opening text
